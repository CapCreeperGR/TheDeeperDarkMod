...
public class ModItems {
    ...
    public static final Item SCULK_CRYSTAL_SWORD = registerItem("sculk_crystal_sword",
            new SwordItem(ModToolMaterials.SCULK_CRYSTAL,4,0.2f,new FabricItemSettings().group(ItemGroup.COMBAT)));
    public static final Item SCULK_CRYSTAL_PICKAXE = registerItem("sculk_crystal_pickaxe",
            new ModPickaxeItem(ModToolMaterials.SCULK_CRYSTAL,0,0.2f,new FabricItemSettings().group(ItemGroup.TOOLS)));
    public static final Item SCULK_CRYSTAL_AXE = registerItem("sculk_crystal_axe",
            new ModAxeItem(ModToolMaterials.SCULK_CRYSTAL,6,0.2f,new FabricItemSettings().group(ItemGroup.TOOLS)));
    public static final Item SCULK_CRYSTAL_HOE = registerItem("sculk_crystal_hoe",
            new ModHoeItem(ModToolMaterials.SCULK_CRYSTAL,0,0.2f,new FabricItemSettings().group(ItemGroup.TOOLS)));
    ...
    public static final Item SCULK_CRYSTAL_HELMET = registerItem("sculk_crystal_helmet",
            new ArmorItem(ModArmorMaterials.SCULK_CRYSTAL, EquipmentSlot.HEAD,new FabricItemSettings().group(ItemGroup.COMBAT)));
    public static final Item SCULK_CRYSTAL_CHESTPLATE = registerItem("sculk_crystal_chestplate",
            new ArmorItem(ModArmorMaterials.SCULK_CRYSTAL, EquipmentSlot.CHEST,new FabricItemSettings().group(ItemGroup.COMBAT)));
    public static final Item SCULK_CRYSTAL_LEGGINGS = registerItem("sculk_crystal_leggings",
            new ArmorItem(ModArmorMaterials.SCULK_CRYSTAL, EquipmentSlot.LEGS,new FabricItemSettings().group(ItemGroup.COMBAT)));
    public static final Item SCULK_CRYSTAL_BOOTS = registerItem("sculk_crystal_boots",
            new ArmorItem(ModArmorMaterials.SCULK_CRYSTAL, EquipmentSlot.FEET,new FabricItemSettings().group(ItemGroup.COMBAT)));
